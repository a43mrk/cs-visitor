...
import { Namespace_Context } from "./css3Parser";
...
import { Operator_Context } from "./css3Parser";
import { Property_Context } from "./css3Parser";
...
import { Function_Context } from "./css3Parser";
...
import { Any_Context } from "./css3Parser";
...
import { Var_Context } from "./css3Parser";
...
export interface css3Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `css3Parser.namespace_`.
	 * @param ctx the parse tree
	 */
	enterNamespace_?: (ctx: Namespace_Context) => void;
	/**
	 * Exit a parse tree produced by `css3Parser.namespace_`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by `css3Parser.operator_`.
	 * @param ctx the parse tree
	 */
	enterOperator_?: (ctx: Operator_Context) => void;
	/**
	 * Exit a parse tree produced by `css3Parser.operator_`.
	 * @param ctx the parse tree
	 */
	exitOperator_?: (ctx: Operator_Context) => void;

	/**
	 * Enter a parse tree produced by `css3Parser.property_`.
	 * @param ctx the parse tree
	 */
	enterProperty_?: (ctx: Property_Context) => void;
	/**
	 * Exit a parse tree produced by `css3Parser.property_`.
	 * @param ctx the parse tree
	 */
